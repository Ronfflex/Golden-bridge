...
contract DeployLotterie is Script {
    ...
    function run() external {
        ...
        bytes memory data = abi.encodeWithSelector(Lotterie(implementation).initialize.selector, owner, 2607541693386182620148067725411559151504172322007266401353081426276952558330, vrfCoordinator, bytes32(0x787d74caea10b2b357790d5b5247c2f63d1d91572a9846f780606e4d953677ae), 40000, 3, 1, goldToken);
